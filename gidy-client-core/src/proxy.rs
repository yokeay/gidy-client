...
async fn handle_socks5(
    ...
    let _remaining_data = if buf_len > total_request_len {
    ...
    // Bidirectional relay between SOCKS5 client and tunnel
    if let Err(e) = tunnel.relay(stream).await {
